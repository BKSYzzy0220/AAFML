...
class MiniImagenet(Dataset):
    ...
    def create_batch(self, batchsz):
        ...
        for b in range(batchsz):  # for each batch
            ...
            selected_cls = [0] + list(np.random.choice(self.cls_num - 1, self.n_way - 1, False) + 1)
...
if __name__ == '__main__':
    ...
    mini = MiniImagenet('../mini-imagenet/', mode='train', n_way=5, k_shot=5, k_query=15, batchsz=1000, resize=168)
